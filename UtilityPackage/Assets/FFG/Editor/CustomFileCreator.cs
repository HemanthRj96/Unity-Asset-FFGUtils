...
public static class CustomFileCreator
{
    ...
    private const string _FILE_PATH_ = @"Assets/FFG/Editor/Script Templates/";
    ...
    /// </summary>
    [MenuItem(itemName: "FFG/Create Game Manager [Type: GameManager, FileType: GameObject]", isValidateFunction: false)]
    ...
    /// </summary>
    [MenuItem(itemName: "FFG/Create Level Manager [Type: LevelManager, FileType: GameObject]", isValidateFunction: false)]
    ...
    /// </summary>
    [MenuItem(itemName: "FFG/Create Sound Manager [Type: SoundManager, FileType: GameObject]", isValidateFunction: false)]
