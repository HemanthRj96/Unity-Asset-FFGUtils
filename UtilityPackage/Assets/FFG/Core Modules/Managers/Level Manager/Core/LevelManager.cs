...
#pragma warning disable 0414
        ...
        [SerializeField] private SubLevelManager[] _subManagers = default;
#pragma warning restore 0414
        ...
        private Dictionary<string, SubLevelManager> _levelControllersLookup = new Dictionary<string, SubLevelManager>();
        private SubLevelManager _cachedLevelController = null;
        ...
        {
            foreach (SubLevelManager controller in _subManagers)
                if (controller != null)
        ...
        private SubLevelManager fetchLevelController(string levelName)
        {
