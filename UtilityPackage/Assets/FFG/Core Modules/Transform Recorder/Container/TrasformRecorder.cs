...
namespace FFG.TrasformRecorder
{
    public class TrasformRecorder
    {
        ...
        public static void WriteData(AnalogTransform data, string filepath, string filename)
        {
            ...
            FFG.JsonSaver.JsonSaver.WriteData(saveData, filepath, filename);
        ...
        public static AnalogTransform ReadData(string filepath, string filename)
        {
            ...
            // Read data
            FFG.JsonSaver.JsonSaver.ReadData(filepath, filename, out SaveData data);
