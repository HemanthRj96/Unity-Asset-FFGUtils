...
namespace FFG.TrasformRecorder
{
    ...
    /// </summary>
    public class TransformRecorderComponent : MonoBehaviour
    {
        /*.............................................Serialized Fields....................................................*/
        ...
        private IEnumerator recorder()
        {
            while (true)
            {
                ...
                else if (_states == ERecorderStates.Stopped)
                {
                    ...
                    // Write data
                    TrasformRecorder.WriteData(_transformData, Application.persistentDataPath + $"/{_filepath}", _filename);
        ...
        private IEnumerator replayer()
        {
            ...
            {
                _transformData = TrasformRecorder.ReadData(Application.persistentDataPath + $"/{_filepath}", _filename);
