...
namespace FickleFrames.Systems.Editor_
{
    ...
    public class ActionSettingsDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect rect, SerializedProperty property, GUIContent label)
        {
            ...
            nextLine(ref rect);
            bool _shouldRegisterCache = _onActionBeginCache == EActionExecutionMode.ExecuteExternally;

            if (_shouldRegisterCache)
                _shouldRegister.boolValue = _shouldRegisterCache;

            EditorGUI.BeginDisabledGroup(_shouldRegisterCache);
